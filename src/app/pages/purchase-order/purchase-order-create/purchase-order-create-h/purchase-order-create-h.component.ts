...
export class PurchaseOrderCreateHComponent implements OnInit {
  ...
  clearPph() {
    ...
    this.formGroup.patchValue({
      ...
      pphTaxObject: '',
      pphPercentage: 0,
      // Mengosongkan kode mengembalikan SPK ke keadaan "belum diputuskan" —
      // pernyataan tanpa-PPh dicentang sendiri, bukan diwariskan.
      tanpaPph: false,
    });
  }
      ...
      next: (induk: any) => {
        ...
        this.adendum.isiLarik(
          ...
          (x) => {
            ...
            g.patchValue(BALIK_BARIS['h'](x, this.isUbah));
            return g;
          },
        );
        /*
