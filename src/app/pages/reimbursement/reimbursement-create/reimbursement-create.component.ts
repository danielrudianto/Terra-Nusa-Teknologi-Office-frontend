...
export class ReimbursementCreateComponent {
  ...
  generatePDF(reimbursementName: string) {
    const date = new Date(this.formGroup.get('date')?.value);
    const projectName = this.formGroup.get('projectName')?.value;
    const reimbursementItems = this.formGroup.value.items.map((item: any) => {
      const itemDate = new Date(item.date);
      return {
        ...item,
        date: itemDate,
          ...
          table: {
            ...
            body: [
              ...
              [
                ...
                {
                  text: `: ${this.formGroup.get('bankName')?.value}`,
                  colSpan: 2,
                },
                {},
              ],
              [
                ...
                {
                  text: `: ${this.formGroup.get('bankAccountName')?.value}`,
                  colSpan: 2,
                },
                {},
              ],
              [
                ...
                {
                  text: `: ${this.formGroup.get('bankAccountNumber')?.value}`,
                  colSpan: 2,
                },
                {},
              ],
