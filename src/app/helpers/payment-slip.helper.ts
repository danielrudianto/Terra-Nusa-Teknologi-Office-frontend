...
export interface IPurchasePaymentSlip {
  ...
  total: number;
  bankAccountNameOrigin: string;
  bankAccountNumberOrigin: string;
  bankNameOrigin: string;
}

export interface IReimbursementPaymentSlip {
  projectName: string;
  createdAt: Date;
  date: string;
  paymentDate: string;
          ...
          table: {
            ...
            body: [
              ...
              [
                ...
                {
                  text: Number(data.dpp).toLocaleString('id-ID', {
              ...
              [
                ...
                {
                  text: data.taxInvoiceName,
                },
                {
                  text: Number(data.ppn).toLocaleString('id-ID', {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  }),
                },
              ...
              [
                ...
                },
                {
                  text:
                    data.pphCode == null
                      ? 'N/A'
                      : `[${data.pphCode}] ${data.pphTaxObject} (${data.pphPercentage}%)`,
                },
                {
                  text: ((data.pphPercentage * data.dpp) / 100).toFixed(2),
                },
                {
                  text: data.pphCode == null ? 'N/A' : 'Next reporting date',
                },
              ],
              [
                {
                ...
                {
                  text: Number(data.pbbkb).toLocaleString('id-ID', {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  }),
                },
              ...
              [
                ...
                {
                  text: data.otherValue == 0 ? 'N/A' : data.otherValueNote,
                },
                {
                  text: Number(data.otherValue).toLocaleString('id-ID', {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  }),
                },
              ...
              [
                ...
                {
                  text: Number(data.total).toLocaleString('id-ID', {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  }),
                },
          ...
          table: {
            ...
            body: [
              ...
              [
                ...
                {
                  text: data.bankAccountNameOrigin,
                },
              ],
              [
                {
                ...
                {
                  text: data.bankAccountNumberOrigin,
                },
              ],
              [
                {
              ...
              [
                ...
                {
                  text: data.amount.toLocaleString('id-ID', {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  }),
                },
