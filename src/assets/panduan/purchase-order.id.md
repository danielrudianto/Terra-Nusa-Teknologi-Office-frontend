...
> Penting: panduan ini baru mencakup lima jenis PO — **C, F, G, 5.1.1, dan
> 5.1.6**. Jenis lain masih dikembangkan dan sengaja belum didokumentasikan
> supaya panduannya tidak menyesatkan.

## Jenis yang sudah tercakup

Kelimanya memakai formulir yang sama. Yang membedakan hanya isian tambahan di
bagian akhir.
